                    ...
                    <Table className="project-list-table table-nowrap align-middle table-borderless">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Check in Time/Out </th>
                          <th scope="col">Status</th>
                          <th scope="col">Check in and Check out Image</th>
                      ...
                      <tbody>
                        {map(projects, (project, index) => (
                          <tr key={index}>
                            ...
                            <td>
                             <button aria-haspopup="true" class="btn btn-primary" aria-expanded="false">View</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                        ...
                        >
                          <Row form>
                            <Col xs={12}>
                              ...
                              <AvField type="hidden" value={ this.state.compprojects.img || "" } name="img" />

                              <AvField type="hidden" value={ this.state.compprojects.team || "" } name="team" />
                              ...
                              <div className="mb-3">
                                <AvField
                                  ...
                                  value={ this.state.compprojects.name || "" }
                                />
                              </div>
                              ...
                              <div className="mb-3">
                                <AvField
                                  ...
                                  value={this.state.compprojects.description || "" }
                                />
                              </div>
                              ...
                              <div className="mb-3">
                                <AvField
                                  ...
                                  value={this.state.compprojects.status || "Pending" }
                                >
                              ...
                              <div className="mb-3">
                                <AvField
                                  ...
                                  value={this.state.compprojects.color || "success" }
                                >
                              ...
                              <div className="mb-3">
                                ...
                                <AvField
                                  ...
                                  value={this.state.compprojects.dueDate || "" }
                                >
                                </AvField>
