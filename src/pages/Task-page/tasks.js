    ...
    return (
      <React.Fragment>
        <Col xl="6">
          <Card>
            <CardBody>
              <h4 className="card-title mb-4">Contract and Documents</h4>
                    ...
                    <Table className="table table-nowrap align-middle table-hover mb-0">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">15 January 2020</p>
                        </td>
                        <td style={{ width: "90px" }}>
                          <div>
                      ...
                      <tr>
                        ...
                        <td>
                          <h5 className="text-truncate font-size-14 mb-1">
                            <Link to="#" className="text-dark">
                              Purbly Management Sdn Bhd
                            </Link>
                          </h5>
                          <p className="text-muted mb-0">5 December 2020</p>
                        </td>
                        <td>
                          <div>
                            <ul className="list-inline mb-0 font-size-16">
