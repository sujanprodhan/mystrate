          ...
          <Card>
            <CardBody>
              ...
              <div>
                ...
                <div>
                  ...
                  <p className="text-muted mb-1">Flexi plan</p>
            ...
            <CardBody className="border-top">
              <Row>
                <div className="col-sm-6">
                  <div>
                    <p className="fw-medium mb-2">Rank</p>
                    <h4>178</h4>
                  </div>
                </div>
                <div className="col-sm-6">
            ...
            <CardFooter className="bg-transparent border-top">
              <div className="text-center">
                <Link to="#" className="btn btn-outline-light me-2 w-md">Invoice </Link>{" "}
                <Link to="#" className="btn btn-primary me-2 w-md">Setting</Link>
              </div>
            </CardFooter>
          </Card>
        </Col>
