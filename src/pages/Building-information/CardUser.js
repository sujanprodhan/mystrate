      ...
      <React.Fragment>
        <Col xl={8}>
              ...
              <Card className="mini-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Total Tower</p>
            ...
            <Col lg={4}>
              <Card className="blog-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Total Level</p>
            ...
            <Col lg={4}>
              <Card className="blog-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Total Areas</p>
          ...
          <Card>
            <CardBody>
              <div className="d-flex flex-wrap">
                <h5 className="card-title me-2">Utilities</h5>
              ...
              <Row className="text-center">
                ...
                <Col lg={4}>
                  <div className="mt-4">
                    <p className="text-muted mb-1">Total This Year</p>
                    <h5>
                      RM 102354{" "}
                      <span className="text-success font-size-13">
