...
import SplineArea from "../AllCharts/apex/dashboardspinal"

export default class CardUserlatest extends Component {
  constructor(props) {
    super(props)
    this.state = {}
  }
              ...
              <Card className="mini-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Active Renovation</p>
            ...
            <Col lg={4}>
              <Card className="blog-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Activing Moving</p>
            ...
            <Col lg={4}>
              <Card className="blog-stats-wid">
                <CardBody>
                  <div className="d-flex flex-wrap">
                    <div className="me-3">
                      <p className="text-muted mb-2">Active Booking</p>
