          ...
          <Card>
            <CardBody>
              ...
              <div>
                ...
                <div>
                  <h5>Purbly</h5>
                  <p className="text-muted mb-1">Building Management Company</p>
                  <p className="text-muted mb-0">Contract End @ 15 December 2022</p>
                </div>
              </div>
            </CardBody>
            ...
            <CardBody className="border-top">
              <Row>
                <div className="col-sm-6">
                  <div>
                    <p className="fw-medium mb-2">Total Staff</p>
                    <h4>6</h4>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="mt-4 mt-sm-0">
                    <p className="fw-medium mb-2">Main Service Provider</p>
            ...
            <CardFooter className="bg-transparent border-top">
              <div className="text-center">
                <Link to="attendance-page" className="btn btn-outline-light me-2 w-md">View Attendance</Link>{" "}
                <Link to="#" className="btn btn-primary me-2 w-md">Download PDF</Link>
              </div>
            </CardFooter>
          </Card>
        </Col>
