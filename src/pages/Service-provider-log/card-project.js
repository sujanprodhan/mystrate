    ...
    <React.Fragment>
        ...
        <div class="card">
            ...
            <div class="media">
              <div class="avatar-md me-4">
                <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                  <a href="/serviceprovidercontract">
                    <img src={company1} alt="" height="30" />
                  </a>
                </span>
              </div>
              ...
              <img src="/static/media/avatar-5.a5c59cee.jpg" class="rounded-circle avatar-xs" alt="" />
                  ...
                  <div class="avatar-group">
                    <div class="avatar-group-item">
                      <a href="#">
                        <UiLightboxCommon
                          lightImage={["/static/media/avatar-4.b23e41d9.jpg"]}
                        />
                      </a>
                    </div>
                    <div class="avatar-group-item">
                      <a href="#">
                        <UiLightboxCommon
                          lightImage={["/static/media/avatar-5.a5c59cee.jpg"]}
                        />
                      </a>
                    </div>
                  </div>
          ...
          <div class="px-4 py-3 border-top">
            <ul class="list-inline mb-0">
              <li class="list-inline-item me-3">15 Staff</li>
              <li class="list-inline-item me-3" id="dueDate">
                <i class="bx bx-calendar me-1"></i> Contract Till 2019-10-15
              </li>
            </ul>
          </div>
        </div>
      ...
      <Col xl="4">
        <div class="card">
          ...
          <div class="px-4 py-3 border-top">
            <ul class="list-inline mb-0">
              <li class="list-inline-item me-3">25 Staff</li>
              <li class="list-inline-item me-3" id="dueDate">
                <i class="bx bx-calendar me-1"></i> Contract Till 2019-10-15
              </li>
            </ul>
