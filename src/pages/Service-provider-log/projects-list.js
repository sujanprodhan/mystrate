                    ...
                    <Table className="project-list-table table-nowrap align-middle table-borderless">
                      <thead>
                        ...
                        <tr>
                          ...
                          <td><h5 class="text-truncate font-size-14"><Link class="text-dark" to="/IndividualServiceProviderlog">Report text here</Link></h5><p class="text-muted mb-0">It will be as simple as Occidental</p></td>
                          <td><th scope="col">13 November 2021</th></td>
                          <td><th scope="col">9:00 AM</th></td>
                          <td><th scope="col"><span class="bg-success badge badge-success">Cleaner</span></th></td>
                          ...
                          <td class="d-grid gap-2"><Link class="btn btn-primary" to="/IndividualServiceProviderlog" role="button">View</Link></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><h5 class="text-truncate font-size-14"><a class="text-dark" href="/IndividualServiceProviderlog">Report text here</a></h5><p class="text-muted mb-0">It will be as simple as Occidental</p></td>
                          <td><th scope="col">13 November 2021</th></td>
                          <td><th scope="col">9:00 AM</th></td>
                          <td><th scope="col"><span class="bg-success badge badge-success">Security</span></th></td>
                        ...
                        <tr>
                          ...
                          <td><th scope="col">13 November 2021</th></td>
                          <td><th scope="col">9:00 AM</th></td>
                          <td><th scope="col"><span class="bg-success badge badge-success">Lift</span></th></td>
                        ...
                        <tr>
                          ...
                          <td><th scope="col">13 November 2021</th></td>
                          <td><th scope="col">9:00 AM</th></td>
                          <td><th scope="col"><span class="bg-warning badge badge-success">Security</span></th></td>
